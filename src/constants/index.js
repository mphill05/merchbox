...
export const clientImages = [
  {
    image: '/aeforia.png',
    label: 'Aeforia',
    link: 'https://www.instagram.com/aeforia/'
  },
  {
    image: '/arty.png',
    label: 'Arty',
    link: 'https://www.instagram.com/artymusic/'
  },
  {
    image: '/boomboxCartel.png',
    label: 'Boombox Cartel',
    link: 'https://www.instagram.com/boomboxcartel/'
  },
  {
    image: '/crimewave.png',
    label: 'Crimewave',
    link: 'https://www.instagram.com/crimewave/'
  },
  {
    image: '/diamondPistols.png',
    label: 'Diamond Pistols',
    link: 'https://www.instagram.com/diamondpistols/'
  },
  {
    image: '/dijon.png',
    label: 'Dijon',
    link: 'https://www.instagram.com/dijondijon_/'
  },
  {
    image: '/discolines.png',
    label: 'DiscoLines',
    link: 'https://www.instagram.com/discolines/'
  },
  {
    image: '/donFuego.png',
    label: 'Don Fuego',
    link: 'https://www.instagram.com/donfuegohotsauce/'
  },
  {
    image: '/dylanAndHarry.png',
    label: 'Dylan & Harry',
    link: 'https://www.instagram.com/dnhservices/'
  },
  {
    image: '/frosttop.png',
    label: 'Frosttop',
    link: 'https://www.instagram.com/frosttopmusic/'
  },
  {
    image: '/ghostHardware.png',
    label: 'Ghost Hardware',
    link: 'https://www.instagram.com/ghost____hardware/'
  },
  {
    image: '/girlAndTheGoat.png',
    label: 'Girl & The Goat',
    link: 'https://www.instagram.com/girl.and.the.goat/'
  },
  {
    image: '/isoxo.png',
    label: 'Isoxo',
    link: 'https://www.instagram.com/isoxo_/'
  },
  {
    image: '/juelz.png',
    label: 'Juelz',
    link: 'https://www.instagram.com/bbjuelz/'
  },
  {
    image: '/knock2.png',
    label: 'Knock2',
    link: 'https://www.instagram.com/knock2music/'
  },
  {
    image: '/monta.png',
    label: 'Monta',
    link: 'https://www.instagram.com/montarecs/'
  },
  {
    image: '/morganPage.png',
    label: 'Morgan Page',
    link: 'https://www.instagram.com/morganpage/'
  },
  {
    image: '/nightmode.png',
    label: 'Nightmode',
    link: 'https://www.instagram.com/nightmode/'
  },
  {
    image: '/partyFavor.png',
    label: 'Party Favor',
    link: 'https://www.instagram.com/partyfavor/'
  },
  {
    image: '/peekaboo.png',
    label: 'Peekaboo',
    link: 'https://www.instagram.com/peekaboobeats/'
  },
  {
    image: '/shipwrek.png',
    label: 'Shipwrek',
    link: 'https://www.instagram.com/shipwrekdj/'
  },
  {
    image: '/sidepiece.png',
    label: 'Sidepiece',
    link: 'https://www.instagram.com/youasidepiece/'
  },
  {
    image: '/ternionSound.png',
    label: 'Ternion Sound',
    link: 'https://www.instagram.com/ternionsound/'
  },
  {
    image: '/yellowClaw.png',
    label: 'Yellow Claw',
    link: 'https://www.instagram.com/yellowclaw/'
  }
];
...
export const faqData = [
  {
    ...
    content: 'Typically 2-3 weeks from payment of deposit invoice. Jobs requiring faster turnarounds may incur rush fees depending on current schedule, but we aim to accommodate as much as is reasonably possible.'
  },
  {
    title: 'CAN I SUPPLY MY OWN BLANK GARMENTS FOR PRINTING?',
    content: 'Unfortunately we do not accept blank garments from customers. Merchbox has accounts with most major and boutique vendors, so we are able to acquire all sorts of blanks for you. If there is a particular vendor you have in mind that we don\'t already have accounts with, we are more than happy to make one. This process ensures that all of the blanks are up to standard so we can best serve your project!'
  },
  {
    title: 'DO YOU OFFER FULFILLMENT SERVICES?',
    content: 'Our fulfillment program is offered to our higher volume clients, so please tell us more about your fulfillment needs using our contact page to see if it\'s the right fit!'
  },
  {
  ...
  },
  {
    ...
    content: 'We are not currently offering Print on Demand, but a great solution is to do pre-orders which we offer to our high volume clients.'
  },
  {
    title: 'WHAT\'S THE DIFFERENCE BETWEEN SCREEN PRINTING AND DIRECT TO GARMENT PRINTING (DTG)?',
  ...
  },
  {
    ...
    content: 'Yes! Samples may take up to 2-3 weeks and are at sample pricing based on the project. Please inquire with our team for more info.'
  },
  {
